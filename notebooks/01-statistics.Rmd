...
These flowcharts do not encourage much in the way of thought about the underlying structures, models and processes of these methods. Some people might see this flowchart and think that the small collection of tests shown in it will do for all circumstances (which is absolutely not true). A flowchart like this doesn't present any conceptual framework that helps researchers through the inevitable cases where a formulaic application following the arrows is inappropriate for the question being asked of the research.

In fact, these classical statistical methods also tend to be inflexible and fragile: unable to adapt to novel contexts not met by their assumptions; and failing in unpredictable ways when they meet those contexts. These novel contexts arise fairly frequently in research, and the flowcharts don't tell you where the boundaries of applicability are.
...
One of our goals is to encourage you to look beyond a rote application of "The Null Ritual" (coined in [Gigerenzer (2004) *J. Socio-Econ.* doi:10.1016/j.socec.2004.09.033](https://doi.org/10.1016/j.socec.2004.09.033)), as though it's a hammer and every problem is a nail to be hammered down. The tests in the hypothesis-testing decision tree can be used in this way. That flowchart is, in some ways, a toolbox containing only hammers.
