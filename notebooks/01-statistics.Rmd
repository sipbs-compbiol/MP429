...
hist(data, col="cornflowerblue", breaks=40, freq=FALSE,
     main=NULL, xlab="value", ylab="frequency", xlim=c(0, 20))

# Curve of distrubution
x = seq(0, 20, length=100)
y = dnorm(x, mean=mu, sd=sd)
lines(x, y)
abline(v=c(4, 7, 13, 16), lwd=2, lty=3, col="goldenrod")
abline(v=10, lty=5, lwd=3, col="darkorange1")

# axis(1,
#     at=c(mu-2*sd, mu-sd, mu, mu + sd, mu + 2* sd),
