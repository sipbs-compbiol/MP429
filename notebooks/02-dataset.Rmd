...
The interactive tables below show some example datasets.
...
We can visualise relationships between the variables with a pairs plot.
...
2. Which variables look like they are correlated?
</div>
...
3. Do the pairs plots appear to suggest any potential problems with either the `iris` or `pima` dataset?
</div>

# Types of variable

When analysing an experiment, especially when critically reviewing someone else's work, it is very important to understand the dataset. There are two main types of data: numerical and categorical
