...
The interactive widgets below show some example datasets.
...
Again, we can visualise relationships with a pairs plot,
...
Measurements are always taken as *discrete* values, such as mass to the nearest gramme, but we *model* the measurements on their underlying continuous scale.
</div>
