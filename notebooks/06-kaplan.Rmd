...
```{r survival-exp, echo=FALSE, fig.cap="An exponential survival function. The proportion of entities survivng for more than one month is 0.37"}
lambda = 1
...
```{r lung-fit1, echo=FALSE, fig.cap="Survival function for the complete `lung` dataset, as the solid black line. Censored data is shown by a cross for the corresponding individual, at the time of censoring. The grey ribbon shows the 95% confidence interval for the survival function. The median time to survival is around 310 days."}
