...
1. How good is the *fit* of the model as you vary the model parameters?
2. How do the residual plots vary, as you change model parameters?
3. What does the residual plot look like, when you think you have found the best fit?
4. Does the line ever exactly match the data?
5. Does the number of datapoints matter?
</div>
  ...
  column(12,
         renderPlot({
           ...
           p1 = p1 + annotate("segment",
                              ...
                              y=pmax(0, resids$y_line), yend=pmin(50, data$ym),
